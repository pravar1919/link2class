...
class Career(models.Model):
    ...
    extra_field     = models.CharField(max_length=220, default='Career')
    ...
    liked = models.ManyToManyField(
        User, blank=True, related_name='career_likes')
...
class Like(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='career_like_user')
