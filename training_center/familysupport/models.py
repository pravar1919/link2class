...
class FamilySupport(models.Model):
    ...
    extra_field     = models.CharField(max_length=220, default='familysupport')
    ...
    liked = models.ManyToManyField(
        User, blank=True, related_name='familysupport_likes')
    ...
    class Meta:
        verbose_name_plural = 'FamilySupport'
...
class Like(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='familysupport_like_user')
    post = models.ForeignKey(FamilySupport, on_delete=models.CASCADE)
