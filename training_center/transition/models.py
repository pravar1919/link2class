...
class Transition(models.Model):
    ...
    extra_field     = models.CharField(max_length=220, default='transition')
    ...
    liked = models.ManyToManyField(
        User, blank=True, related_name='transition_likes')
...
class Like(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='transition_like_user')
    post = models.ForeignKey(Transition, on_delete=models.CASCADE)
