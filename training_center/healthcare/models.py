...
class HealthCare(models.Model):
    ...
    extra_field     = models.CharField(max_length=220, default='healthcare')
    ...
    liked = models.ManyToManyField(
        User, blank=True, related_name='healthcare_likes')
    ...
    class Meta:
        verbose_name_plural = 'HealthCare_Videos'
...
class Like(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='healthcare_like_user')
    post = models.ForeignKey(HealthCare, on_delete=models.CASCADE)
