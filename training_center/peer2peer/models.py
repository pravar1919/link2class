...
class Peer2Peer(models.Model):
    author          = models.ManyToManyField(User, blank=True)
    extra_field     = models.CharField(max_length=220, default='peer2peer')
    ...
    liked = models.ManyToManyField(
        User, blank=True, related_name='peer2peer_likes')
...
class Like(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='peer2peer_like_user')
    post = models.ForeignKey(Peer2Peer, on_delete=models.CASCADE)
